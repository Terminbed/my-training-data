# Athlete Dossier: Terminbed

## 1. Physiology & Credentials
- **Athlete ID:** i149574
- **Role:** Engineering Consultant (MSc Mechanical Engineering)
- **Age:** 29 (Born 1996)
- **Weight:** 75kg | **Height:** 183cm
...
- **Zone Logic:** Intervals.icu Defaults (Coggan Power / Friel HR)
- **Zone Preference:** cycling:power, run:hr (once recovered)

## 3. Training Context & Schedule
- **Weekly Volume:** 10–15 hours total
- **Commuting:** ~60 mins/week (active recovery/Z1)
- **Strength:** 2x Full Body sessions per week (Dumbbells/Bench)
- **Group Ride:** Saturdays (3h+ social/intense)
- **Injury Status:** Recovering from injury. 
  - **Constraint:** Strictly NO RUNNING until cleared. 
  - **Focus:** Low-impact cycling + rehab (Hips/Glutes/Calves).
  - **Future State:** Integrate 2x run sessions/week post-recovery.

## 4. Equipment
- **Turbo:** Wahoo Kickr V6
- **Strength:** Adjustable Dumbbells (5–41.5kg), Adjustable Bench, Pull-up Bar
...
2. Increase cycling FTP.
3. Maintain strength/mass through structured dumbbell work.
